(function () {
    ...
    angular.module('app.table').controller('CollectedItemReportCtrl', ['$q', '$scope', '$http', '$filter', '$mdDialog', 'config', 'appConstants', 'service', 'materials', 'reportModel', 'commonModel', CollectedItemReportCtrl]);

    function CollectedItemReportCtrl($q, $scope, $http, $filter, $mdDialog, config, appConstants, service, materials, reportModel, commonModel) {
