        ...
        $scope.print = function (rowData) {
          ...
          '<tr >';
            ...
            for (var k = 0; k < $scope.currentPageresultData.length; k++) {
                ...
                var _cridate = $scope.currentPageresultData[k].criticaldate != null ? materials.stockconvertdatetime(new Date($scope.currentPageresultData[k].criticaldate), "D") : "";
                body += '<tr>' +


                   
                //'<td style="border-bottom: 1px solid #ddd;">' + n + '</td>' +
                '<td style="border-bottom: 1px solid #ddd;">' + $scope.currentPageresultData[k].projectname + '</td>' +
                '<td style="border-bottom: 1px solid #ddd;">' + $scope.currentPageresultData[k].tasktitle + '</td>' +
                '<td style="border-bottom: 1px solid #ddd;">' + $scope.currentPageresultData[k].taskstatusname + '</td>' +
                 '<td style="border-bottom: 1px solid #ddd;">' + $scope.currentPageresultData[k].skillname + '</td>' +
                ...
                '<td style="border-bottom: 1px solid #ddd;">' + materials.stockconvertdatetime(new Date($scope.currentPageresultData[k].taskpublishdate), "D") + '</td>' +
                '<td style="border-bottom: 1px solid #ddd;">' + _cridate + '</td>' +
                '<td style="border-bottom: 1px solid #ddd;">' + isnull($scope.currentPageresultData[k].customerrate )+ '</td>' +
                '<td style="border-bottom: 1px solid #ddd;">' + isnull($scope.currentPageresultData[k].rate) + '</td>' +
                '<td style="border-bottom: 1px solid #ddd;">' + isnull($scope.currentPageresultData[k].targetcount) + '</td>' +
                '</tr>';
            }
