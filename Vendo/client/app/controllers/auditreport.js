(function () {
    ...
    angular.module('app.table').controller('AuditReportCtrl', ['$q', '$scope', '$http', '$filter', '$mdDialog', 'config', 'appConstants', 'service', 'materials', 'reportModel', 'commonModel', AuditReportCtrl]);

    function AuditReportCtrl($q, $scope, $http, $filter, $mdDialog, config, appConstants, service, materials, reportModel, commonModel) {
        ...
        $scope.print = function (rowData) {
          ...
          '<tr >' +
            ...
            for (var k = 0; k < $scope.currentPageresultData.length; k++) {
                ...
                var completedate = $scope.currentPageresultData[k].actenddate != null ? materials.stockconvertdatetime(new Date($scope.currentPageresultData[k].actenddate), "D") : "";
                ...
                '<td style="border-bottom: 1px solid #ddd;">' + $scope.currentPageresultData[k].targetname + '</td>' +
                ...
                '<td style="border-bottom: 1px solid #ddd;">' + isnull($scope.currentPageresultData[k].auditusername) + '</td>' +
