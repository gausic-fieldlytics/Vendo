(function () {
    ...
    angular.module('app.table')
        .controller('InvoiceReqCtrl', ['$q', '$rootScope', '$scope', '$http', '$filter', '$uibModal', '$mdDialog', 'config', 'appConstants', 'service', 'materials', 'invoiceReqModel', 'commonModel', InvoiceReqCtrl]) 
    ...
    function InvoiceReqCtrl($q, $rootScope, $scope, $http, $filter, $uibModal, $mdDialog, config, appConstants, service, materials, invoiceReqModel, commonModel) {
        var selectedId = 0;
        var original;
        var init;
        ...
        $scope.savepayment = function (row) {
            ...
            result.then(function (resolve) {
                debugger;
                materials.hideSpinner();
                materials.displayToast(appConstants.successClass, "Invoice" + ' ' + appConstants.saveMsg);
                $scope.show = 1;
                loadtask(0);
            }, function (reject) {
                alert('Not Resolved')
