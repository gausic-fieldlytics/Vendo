(function () {
    ...
    angular.module('app.table').constant('appConstants', {
        ...
        //  TASK_POOL_SAMPLE_EL_COL: ["target", "state", "city", "address", "contact", "distributor", "distributorcontact", "latitude", "longitude"],
        TASK_POOL_SAMPLE_EL_COL: ["target"],
        STATE_COL: ["state", "code"],
        CITY_COL: ["state", "city"],
        AREA_COL: ["state", "city", "area", "pincode"],
