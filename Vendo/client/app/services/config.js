(function () {
    ...
    angular.module('app.table').constant('config', {
        ...
        serviceUrl: 'http://vendoservice.ppms.co.in/Task/',
        fileUrl: 'http://vendoservice.ppms.co.in/Upload/',
        filPath: 'http://vendoservice.ppms.co.in/',
        oAuthentication: 'http://vendoservice.ppms.co.in/oauth/token',
        signalr: "http://vendoservice.ppms.co.in/signalr",
