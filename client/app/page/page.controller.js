                ...
                if (response == null || response.error != undefined) {
                    ...
                    if (response.authenticationData == undefined) {
                        ...
                        if (response.authenticationData.usertypeid == 1 || response.authenticationData.usertypeid == 2) {
                            ...
                            sessionStorage.roleid = response.authenticationData.roleid;
                            sessionStorage.clientid = response.authenticationData.clientid;
                            if (!["3", "6"].includes(sessionStorage.userstatusid)) {
                            ...
                            var loadpage = true;
                            if (response.authenticationData.usertypeid == 2 && !["3", "6"].includes(sessionStorage.userstatusid)) {
