(function () {
    ...
    angular.module('app.table').constant('config', {
        ...
        serviceUrl: 'https://activatrservice.ppms.co.in/Task/',
        fileUrl: 'https://activatrservice.ppms.co.in/Upload/',
        filPath: 'https://activatrservice.ppms.co.in/',
        oAuthentication: 'https://activatrservice.ppms.co.in/oauth/token',
        signalr: "https://activatrservice.ppms.co.in/signalr",
