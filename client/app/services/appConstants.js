(function () {
    ...
    angular.module('app.table').constant('appConstants', {
        ...
        contactMsg: 'User Not Exist',
        nameExistMsg: 'Name Exist',
        codeExistMsg: 'Code Exist',
        saveMsg: 'Saved Successfully',
        updateMsg: 'Updated Successfully',
        invalidMsg: "Invalid",
        requiredMsg:"Required.",
        waringMsg: "We cant't delete this #NAME#..?, this #NAME# is mapped with #REFNAME# ",
        otpMsg: "OTP Sended your register mobile number",
        otpErrorMsg: "Invalid OTP",
        passmitxhMsg: "Password and Confirm Password does't match",
        approvedMsg: 'Approved Successfully',
        tryMSG:"Try Again later",
        ...
        tax: "Tax",
        item: "Item",
        taskcancelreason: "Cancel Reason",
        taskclosecallreason: "CloseCall Reason",
        tasksteptype : "Task Step Type",
        taskquestiontype: "Task Question Type",
        ...
        project: 'Project',
        target: 'Target',
        tasktargetmapping: 'Task & Target mapping',
        task: 'Task',
        ...
        ppmsuser: "User",
        taskpicked: "Target Picked",
        targetassign: "Target Assign Successfully ",
        targetcancel: "Target Cancel Successfully",
        ...
        username: "User Name",
        //Domain Lists
        CONST_FP_HMS: "fphms.com",
        BULK_PAYMENT_COL: ["user", "invoiceno", "requestamount", "paidamount", "paymentrefno", "penalty"],
        TARGET_POOL_SAMPLE_EL_COL: ["target","state","city","area","client","street","address","land mark","contact","distributor","distributor contact","pickup location","support contact","support number","latitude","longitude"],
        TASK_POOL_SAMPLE_EL_COL: ["targetname"],
        TASK_POOL_SAMPLE_US_COL: ["isp_agencyname"],
        STATE_COL: ["state", "code"],
        CITY_COL: ["state", "city"],
        AREA_COL: ["state", "city", "pincode"],
        DEPARTMENT_COL: ["department", "code"],
        ROLE_COL: ["role", "code"],
        PAYMENT_MODE_COL: ["paymentmode", "code"],
        PAYMENT_STATUS_COL: ["paymentstatus", "code"],
        PROJECT_STATUS_COL: ["projectstatus", "code"],
        TASK_STATUS_COL: ["taskstatus", "code"],
        SKILL_COL: ["skill", "code"],
        USER_TYPE_COL: ["usertype", "code"],
        USER_STATUS_COL: ["userstatus", "code"],
        CONTACT_TYPE_COL: ["contacttype"],
        PROOF_TYPE_COL: ["prooftype", "code"],
        TAX_COL: ["tax", "code", "percentage"],
        ITEM_COL: ["item", "code"],
        GENDER_COL: ["gender"],
        CANCEL_REASON_COL: ["reason"],
        CLOSECALL_REASON_COL: ["reason","imagerequired"],
    ...
    "IDFC First Bank"],
        LIST_CONSTITUTION:   [{ id: 1, name: "Proprietor" }, { id: 2, name: "Partnership" }, { id: 3, name: "Company" }]
    });
})();
