(function () {
    ...
    angular.module('app.table').controller('InvoiceReportCtrl', ['$q', '$scope', '$http', '$filter', '$mdDialog', 'config', 'appConstants', 'service', 'materials', 'reportModel', 'commonModel', 'targetModel', InvoiceReportCtrl]);

    function InvoiceReportCtrl($q, $scope, $http, $filter, $mdDialog, config, appConstants, service, materials, reportModel,commonModel, targetModel) {
        ...
        $scope.print = function (rowData) {
          ...
          '<tr >' +
            ...
            for (var k = 0; k < $scope.filteredresultData.length; k++) {
                ...
                var invoicedate = $scope.filteredresultData[k].invoicedate != null ? materials.stockconvertdatetime(new Date($scope.filteredresultData[k].invoicedate), "D") : "";
                ...
                var paiddate = $scope.filteredresultData[k].paiddate != null ? materials.stockconvertdatetime(new Date($scope.filteredresultData[k].paiddate), "D") : "";

                body += '<tr>' +
                //'<td style="border-bottom: 1px solid #ddd;">' + n + '</td>' +
                '<td style="border-bottom: 1px solid #ddd;">' + $scope.filteredresultData[k].invoiceno + '</td>' +
                ...
                '<td style="border-bottom: 1px solid #ddd;">' + $scope.filteredresultData[k].auditusername + '</td>' +
                '<td style="border-bottom: 1px solid #ddd;">' + auditdate + '</td>' +
                '<td style="border-bottom: 1px solid #ddd;">' + $scope.filteredresultData[k].paidusername + '</td>' +
                '<td style="border-bottom: 1px solid #ddd;">' + paiddate + '</td>' +
                '<td style="border-bottom: 1px solid #ddd;">' + $scope.filteredresultData[k].paidamount + '</td>' +
                 '<td style="border-bottom: 1px solid #ddd;">' + $scope.filteredresultData[k].paymentmodename + '</td>' +
                '<td style="border-bottom: 1px solid #ddd;">' + isnull($scope.filteredresultData[k].paymentref) + '</td>' +
                '<td style="border-bottom: 1px solid #ddd;">' + isnull($scope.filteredresultData[k].paymentdesc) + '</td>' +
                '</tr>';
            }
